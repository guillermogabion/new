                 ...
                 <ul class="pcoded-item pcoded-left-item">
                     ...
                     <?php if ($_SESSION['user'] == 'admin') { ?>
                         <li class="pcoded-hasmenu">
                             <a href="javascript:void(0)">
                                 ...
                                 <span class="pcoded-mtext">Dentists</span>
                             </a>
                             <ul class="pcoded-submenu">

                                 <li class="">
                                     <a href="doctor.php">
                                         <span class="pcoded-mtext">New Dentist</span>
                                     </a>
                                 </li>

                                 <li class="">
                                     <a href="view-doctor.php">
                                         <span class="pcoded-mtext">View Dentist</span>
                                     </a>
                                 </li>
                             </ul>
                         </li>
                     ...
                     <?php if ($_SESSION['user'] == 'doctor') { ?>
                         <li class="pcoded-hasmenu">
                             <a href="javascript:void(0)">
                                 <span class="pcoded-micon"><i class="feather icon-user"></i></span>
                                 <span class="pcoded-mtext">Dentist</span>
                             </a>
                             <ul class="pcoded-submenu">
