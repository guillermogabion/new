...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
                ...
                <div class="popup__content">
                    ...
                    <p>Dentist Record Updated Successfully</p>
                    <p>
        ...
        ?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
                ...
                <div class="popup__content">
                    ...
                    <p>Dentist Record Inserted Successfully</p>
                    <p>
                        <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
                        <?php echo "<script>setTimeout(\"location.href = 'view-doctor.php';\",1500);</script>"; ?>
                    </p>
                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a>Dentist</a>
                                    </li>
                                ...
                                <div class="card-block">
                                    <form id="main" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Dentist Name</label>
                                            <div class="col-sm-4">
